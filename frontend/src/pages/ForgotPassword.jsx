...
import { Vote, Mail, Lock, Key, Send, ArrowLeft, Loader2 } from 'lucide-react';
...
export default function ForgotPassword() {
  ...
  const handleSendToken = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.error || 'Failed to send token');
    }
    setLoading(false);
  };
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.error || 'Invalid token or failed');
    }
    setLoading(false);
  };
    ...
    <div className="min-h-screen bg-[#0a0a0b] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">KoSh Vote</h1>
        </div>
            ...
            <form onSubmit={handleSendToken} className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#12121a] border-gray-700/50 rounded-xl pl-10 pr-4 py-3 text-white placeholder-gray-600 focus:border-purple-600 outline-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:opacity-90 disabled:opacity-50 text-white py-3 rounded-xl font-medium transition"
              >
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#12121a] border border-gray-700/50 rounded-xl pl-10 pr-4 py-3 text-white placeholder-gray-600 font-mono text-xs focus:border-purple-600 outline-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:opacity-90 disabled:opacity-50 text-white py-3 rounded-xl font-medium transition"
              >
